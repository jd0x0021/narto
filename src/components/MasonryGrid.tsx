...
const MasonryGrid = React.memo(({ children, columnCount, gap }: { children: React.ReactNode, columnCount: number, gap: number }) => {
...
export const GridImage = React.memo(({ item, index }: { item: NormalizedSearchResult, index: number, calculateLayout?: () => void }) => {
